...
struct CMConstraint {
    ...
    struct Attribute {
        ...
        struct Relation {
            ...
            func build(#constant: CGFloat, multiplier: CGFloat)-> NSLayoutConstraint {
                return NSLayoutConstraint(item: item, attribute: attribute, relatedBy: relation, toItem: nil, attribute: .Left, multiplier: multiplier, constant: constant)
            }
            ...
            struct ToItem {
                ...
                struct Build {
                    ...
                    func constraint(constant: CGFloat = 0, multiplier: CGFloat = 1)-> NSLayoutConstraint {
