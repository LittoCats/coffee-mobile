...
struct CMHttp {
    ...
    static let ErrorDomain = "org.littocats.error"
    ...
    */
    ...
    private static func URLRequest(method: Method, URL: URLStringConvertible) -> NSURLRequest {
    ...
    */
    static func request(method: Method, URLString: URLStringConvertible, parameters: [String: AnyObject]? = nil, encoding: ParameterEncoding = .URL) -> Request {
    ...
    */
    static func upload(method: Method, URLString: URLStringConvertible, file: NSURL) -> Request {
    ...
    */
    ...
    :returns: The created upload request.
    */
    static func upload(method: Method, URLString: URLStringConvertible, data: NSData) -> Request {
    ...
    */
    ...
    :returns: The created upload request.
    */
    static func upload(method: Method, URLString: URLStringConvertible, stream: NSInputStream) -> Request {
    ...
    */
    static func download(method: Method, URLString: URLStringConvertible, destination: Request.DownloadFileDestination) -> Request {
    ...
    :returns: The created download request.
    */
    static func download(URLRequest request: URLRequestConvertible, destination: Request.DownloadFileDestination) -> Request {
...
extension CMHttp.ParameterEncoding {
    ...
    func encode(URLRequest: URLRequestConvertible, parameters: [String: AnyObject]?) -> (NSURLRequest, NSError?) {
        ...
        case .URL:
            ...
            func encodesParametersInURL(method: CMHttp.Method) -> Bool {
                switch method {
            ...
            let method = CMHttp.Method(rawValue: mutableURLRequest.HTTPMethod)
    ...
    class Manager {
        ...
        */
        func request(method: Method, _ URLString: URLStringConvertible, parameters: [String: AnyObject]? = nil, encoding: ParameterEncoding = .URL) -> Request {
            return request(encoding.encode(CMHttp.URLRequest(method, URL: URLString), parameters: parameters).0)
        }
...
extension CMHttp.Manager {
    private enum Downloadable {
        case Request(NSURLRequest)
        case ResumeData(NSData)
    }
    
    private func download(downloadable: Downloadable, destination: CMHttp.Request.DownloadFileDestination) -> CMHttp.Request {
        ...
        let request = CMHttp.Request(session: session, task: downloadTask)
        if let downloadDelegate = request.delegate as? CMHttp.Request.DownloadTaskDelegate {
    ...
    :returns: The created download request.
    */
    func download(method: CMHttp.Method, _ URLString: URLStringConvertible, destination: CMHttp.Request.DownloadFileDestination) -> CMHttp.Request {
        return download(CMHttp.URLRequest(method, URL: URLString), destination: destination)
    }
    ...
    :returns: The created download request.
    */
    func download(URLRequest: URLRequestConvertible, destination: CMHttp.Request.DownloadFileDestination) -> CMHttp.Request {
    ...
    :returns: The created download request.
    */
    func download(resumeData: NSData, destination: CMHttp.Request.DownloadFileDestination) -> CMHttp.Request {
...
extension CMHttp.Manager {
    ...
    private func upload(uploadable: Uploadable) -> CMHttp.Request {
        ...
        let request = CMHttp.Request(session: session, task: uploadTask)
    ...
    :returns: The created upload request.
    */
    func upload(URLRequest: URLRequestConvertible, file: NSURL) -> CMHttp.Request {
    ...
    :returns: The created upload request.
    */
    func upload(method: CMHttp.Method, _ URLString: URLStringConvertible, file: NSURL) -> CMHttp.Request {
        return upload(CMHttp.URLRequest(method, URL: URLString), file: file)
    }
    ...
    :returns: The created upload request.
    */
    func upload(URLRequest: URLRequestConvertible, data: NSData) -> CMHttp.Request {
    ...
    :returns: The created upload request.
    */
    func upload(method: CMHttp.Method, _ URLString: URLStringConvertible, data: NSData) -> CMHttp.Request {
        return upload(CMHttp.URLRequest(method, URL: URLString), data: data)
    }
    ...
    :returns: The created upload request.
    */
    func upload(URLRequest: URLRequestConvertible, stream: NSInputStream) -> CMHttp.Request {
    ...
    :returns: The created upload request.
    */
    func upload(method: CMHttp.Method, _ URLString: URLStringConvertible, stream: NSInputStream) -> CMHttp.Request {
        return upload(CMHttp.URLRequest(method, URL: URLString), stream: stream)
    }
}
...
//    
//    public var QueryParams: [String: AnyObject]? {
//        if self.query == nil {return nil}
//        return parseQuery(self.query!) as? [String : AnyObject]
//    }
//    
//    private func parseQuery(query: String) ->AnyObject {
//        
//        
//    }
}
    ...
    */
    ...
    class DownloadTaskDelegate: TaskDelegate, NSURLSessionDownloadDelegate {
        ...
        func URLSession(session: NSURLSession, downloadTask: NSURLSessionDownloadTask, didFinishDownloadingToURL location: NSURL) {
            ...
            downloadProgress?(0, progress.completedUnitCount, progress.totalUnitCount)
            }
        }
...
extension CMHttp.Request: Printable {
...
extension CMHttp.Request: DebugPrintable {
...
extension CMHttp.Request {
    ...
    */
    func responseString(encoding: NSStringEncoding? = nil, completionHandler: (NSURLRequest, NSHTTPURLResponse?, String?, NSError?) -> Void) -> Self  {
        return response(serializer: CMHttp.Request.stringResponseSerializer(encoding: encoding), completionHandler: { request, response, string, error in
...
extension CMHttp.Request {
    ...
    */
    func responseJSON(options: NSJSONReadingOptions = .AllowFragments, completionHandler: (NSURLRequest, NSHTTPURLResponse?, AnyObject?, NSError?) -> Void) -> Self {
        return response(serializer: CMHttp.Request.JSONResponseSerializer(options: options), completionHandler: { (request, response, JSON, error) in
...
extension CMHttp.Request {
    ...
    */
    func responsePropertyList(options: NSPropertyListReadOptions = 0, completionHandler: (NSURLRequest, NSHTTPURLResponse?, AnyObject?, NSError?) -> Void) -> Self {
        return response(serializer: CMHttp.Request.propertyListResponseSerializer(options: options), completionHandler: { (request, response, plist, error) in
